...
#include "Tantrum/InteractInterface.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	TANTRUM_API UClass* Z_Construct_UClass_UInteractInterface();
...
// End Cross Module References
	static UEnum* EEffectType_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_Tantrum_EEffectType, Z_Construct_UPackage__Script_Tantrum(), TEXT("EEffectType"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EEffectType(EEffectType_StaticEnum, TEXT("/Script/Tantrum"), TEXT("EEffectType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_Tantrum_EEffectType_Hash() { return 1028239647U; }
	UEnum* Z_Construct_UEnum_Tantrum_EEffectType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Tantrum();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EEffectType"), 0, Get_Z_Construct_UEnum_Tantrum_EEffectType_Hash(), false);
#else
	...
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UInteractInterface_ApplyEffect_Statics::NewProp_EffectType = { "EffectType", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(InteractInterface_eventApplyEffect_Parms, EffectType), Z_Construct_UEnum_Tantrum_EEffectType, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInteractInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UInteractInterface_ApplyEffect, "ApplyEffect" }, // 862019336
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UInteractInterface, 291542286);
	template<> TANTRUM_API UClass* StaticClass<UInteractInterface>()
	{
		return UInteractInterface::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UInteractInterface(Z_Construct_UClass_UInteractInterface, &UInteractInterface::StaticClass, TEXT("/Script/Tantrum"), TEXT("UInteractInterface"), false, nullptr, nullptr, nullptr);
